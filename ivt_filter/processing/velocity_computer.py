...
class VelocityComputer:
    ...
    def compute(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        """
        # Normalize configured time column to milliseconds to allow microsecond inputs
        df = df.copy()
        time_col = getattr(self.cfg, "time_column", "time_ms")
        time_unit = getattr(self.cfg, "time_unit", "ms")
    ...
    def _compute_all_velocities(
        ...
        from .processing.velocity import compute_olsen_velocity as original_compute
